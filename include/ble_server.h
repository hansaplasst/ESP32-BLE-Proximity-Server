 ...
 *   - Check door state: getDoorState(BLEAddress("AA:BB:CC:DD:EE:FF"));
 *
...
#define DOOR_UUID "6e400002-b5a3-f393-e0a9-e50e24dcca9e"         // Switch control characteristic
#define DOOR_STATUS_UUID "6e400003-b5a3-f393-e0a9-e50e24dcca9e"  // Switch status characteristic
...
bool getDoorState(BLEAddress peerAddress);                            // Check the state of the switch for a given BLE address.
